...
class ArticulosControllerTest < ActionController::TestCase
  ...
  test "should create articulo" do
    assert_difference('Articulo.count') do
      post :create, articulo: { descripcion: @articulo.descripcion, tiempo_preparacion: @articulo.tiempo_preparacion, tipo: @articulo.tipo, title: @articulo.title }
    end
  ...
  test "should update articulo" do
    patch :update, id: @articulo, articulo: { descripcion: @articulo.descripcion, tiempo_preparacion: @articulo.tiempo_preparacion, tipo: @articulo.tipo, title: @articulo.title }
    assert_redirected_to articulo_path(assigns(:articulo))
  end
